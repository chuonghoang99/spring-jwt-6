...
import static com.chuong.app.repositories.specification.SearchOperation.*;
...
public class SpecSearchCriteria {
    ...
    public SpecSearchCriteria(String key, String operation, String value,
        ...
        SearchOperation searchOperation =
                SearchOperation.getSimpleOperation(operation.charAt(0));

        if (searchOperation == EQUALITY) {
            boolean startWithAsterisk =
                    prefix != null && prefix.contains(ZERO_OR_MORE_REGEX);
            boolean endWithAsterisk =
                    suffix != null && suffix.contains(ZERO_OR_MORE_REGEX);
